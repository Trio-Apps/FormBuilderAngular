...
DECLARE @InsertedPermissions INT = 0;

PRINT '========================================';
PRINT 'RESET ALL PERMISSIONS SCRIPT';
PRINT '========================================';
PRINT 'Legal Entity ID: ' + CAST(@LegalEntityId AS VARCHAR(10));
PRINT 'Execution Time: ' + CONVERT(VARCHAR(19), @Now, 120);
PRINT '';
...
-- ============================================
PRINT '========================================';
PRINT 'STEP 1: DELETING EXISTING PERMISSIONS';
PRINT '========================================';

-- 1.1 حذف جميع ربط الصلاحيات بمجموعات المستخدمين (يجب حذفها أولاً بسبب Foreign Key)
PRINT 'Deleting User Group Permissions...';
...
-- ============================================
PRINT '========================================';
PRINT 'STEP 2: INSERTING ALL PERMISSIONS';
PRINT '========================================';
...
-- إدخال في Tbl_UserPermission
PRINT 'Inserting permissions into Tbl_UserPermission...';
...
SELECT
    p.Name,
    p.Description,
    NULL AS ForeignDescription,
    p.ScreenName,
    NULL AS ForeignScreenName,
    p.IsActive,
    @LegalEntityId
FROM @Permissions p;

SET @InsertedPermissions = @@ROWCOUNT;
PRINT 'Inserted ' + CAST(@InsertedPermissions AS VARCHAR(10)) + ' permissions into Tbl_UserPermission';
PRINT '';
...
PRINT 'Permissions inserted: ' + CAST(@InsertedPermissions AS VARCHAR(10));
PRINT '';

-- التحقق من عدد الصلاحيات المضافة
SELECT 
